...
import com.example.cyril.acquistocyril.activites.Rechercher_Article_Ville_Activity;
...
public class RechercheArticleLocaliteDB extends AsyncTask<String,Void,ArrayList<Article>>
    {
        ...
        String result = "";
        try {
            URL url_connexion = new URL("http://10.0.2.2/Android/rechercheArticleLocalite.php");
